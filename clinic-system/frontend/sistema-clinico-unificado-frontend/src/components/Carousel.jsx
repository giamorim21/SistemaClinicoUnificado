    ...
    <div id="visaoCarousel" className="carousel slide" data-bs-ride="carousel">
      ...
      <div className="carousel-inner">
        <div className="carousel-item active text-center">
          <img src="/1.png" className="d-block w-100 rounded-4 shadow-soft" alt="Imagem 1" />
        </div>
        <div className="carousel-item text-center">
          <img src="/2.png" className="d-block w-100 rounded-4 shadow-soft" alt="Imagem 2" />
        </div>
        <div className="carousel-item text-center">
          <img src="/3.png" className="d-block w-100 rounded-4 shadow-soft" alt="Imagem 3" />
        </div>
      </div>
